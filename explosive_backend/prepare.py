...
colname_sql2mongo_map = {
    'DeptID': 'deptid',
    'DeclareTime': 'declaretime',
    'CASNo': 'casno',
    'ChemicalChnName': 'cname',
    'ChemicalEngName': 'ename',
    'SourceDept': 'srcdept',
    'ResponsibleName': 'resname',
    'ResponsibleTel': 'restel',
    'ResponsiblePhone': 'resphone',
    'EmergencyName': 'emername',
    'EmergencyTel': 'emertel',
    'EmergencyPhone': 'emerphone',
    'ComFacBizName': 'comname',
    'BusinessAdminNo': 'adminno',
    'FactoryRegNo': 'regno',
    'ComFacBizAddress': 'addr',
    'PlaceType': 'placetype',
    'RegionType': 'regiontype',
    'RegionName': 'regionname',
    'ComFacBizTWD97X': 'importX',
    'ComFacBizTWD97Y': 'importY',
    'DeclareDate': 'declaredate',
    'ImportQuantity': 'importQ',
    'ProductionQuantity': 'prodQ',
    'ProductionTWD97X': 'prodX',
    'ProductionTWD97Y': 'prodY',
    'UseageQuantity': 'usageQ',
    'UseageTWD97X': 'usageX',
    'UseageTWD97Y': 'usageY',
