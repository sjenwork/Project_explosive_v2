...
var tableForChemSearch = reactive({
    ...
    columns: [
        ...
        },
        {
            ...
            sortable: true,
            display: (row) => {
                return `${operationOptions.value.filter(i => i.eng == row.operation)[0]['chn']} ${row.Quantity.toFixed(2)} 公噸`;
